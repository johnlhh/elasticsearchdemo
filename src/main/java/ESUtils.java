...
public class ESUtils {
     ...
     * es服务器的host
     */
    private static final String host = "192.168.164.128";
...
/*        Client client = TransportClient.builder().build()
    ...
    public static void createIndex(List<Goods> goodsList) throws UnknownHostException, JsonProcessingException {
        ...
        // 创建索引,并设置mapping.
        String mappingStr = "{ \"goods\" : { \"properties\": { \"id\": { \"type\": \"long\" }, \"name\": {\"type\": \"string\", \"analyzer\": \"standard\"}, \"regionIds\": {\"type\": \"string\",\"index\": \"not_analyzed\"}}}}";
